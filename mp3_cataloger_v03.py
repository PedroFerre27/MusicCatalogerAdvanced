...
class MP3CatalogerAdvanced:
    def __init__(self, base_path, log_level=logging.INFO, dry_run=False, use_external_db=True):
        ...
        self.genre_mapping = {
            ...
            'hip hop': 'Hip Hop', 'electronic': 'Electronic', 'dance': 'Dance',
            'reggae': 'Reggae', 'metal': 'Metal', 'blues': 'Blues', 'r&b': 'R&B',
    ...
    def extract_metadata_eyed3(self, file_path):
        ...
        try:
            ...
            # Gestione sicura delle date (evita warning Python 3.15)
            year = None
    ...
    def search_musicbrainz(self, artist, title, album=None):
        ...
        try:
            ...
            self.logger.error(f"Errore ricerca MusicBrainz per {artist} - {title}: {e}")
